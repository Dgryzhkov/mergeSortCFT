...
public class Help {
    public static void displayHelp(){
        System.out.printf("%nСПРАВКА: %n" +
                "java -jar <путь к mergeSortCFT.jar> <тип данных> <имя выходного файла> <имя входного файла> <режим сортировки> %n" +
                ...
                "java -jar mergeSortCFT.jar -i -a out.txt in1.txt in2.txt (для целых чисел по возрастанию)%n" +
                "java -jar mergeSortCFT.jar -s out.txt in1.txt in2.txt in3.txt (для строк по возрастанию)%n" +
                "java -jar mergeSortCFT.jar -d -s out.txt in1.txt in2.txt (для строк по убыванию)%n");
    }
